...
public class Omnipro_Test5_NavegarPorLaWeb extends TestBase {
	
	
	//Logger
	private static final org.apache.logging.log4j.Logger logger=LogManager.getLogger( Omnipro_Test3_LoginFallido.class);
